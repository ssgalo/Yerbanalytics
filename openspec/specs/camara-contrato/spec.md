# camara-contrato Specification

## Purpose
Contrato entre la plataforma y cualquier dispositivo de captura de imágenes cenitales: superficie acotada y versionada, reglas de compatibilidad y evolución, y obligaciones exigibles a un cliente conforme, enunciadas sin depender de la tecnología con que se implemente. Es la fuente de verdad; el backend se implementa contra él.
