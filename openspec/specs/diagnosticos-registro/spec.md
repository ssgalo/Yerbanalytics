# diagnosticos-registro Specification

## Purpose
Alta y consulta de diagnósticos: un camino único, anclado siempre a una captura, que hoy usa la carga manual del simulador y mañana el servicio de inferencia.
