# captura-imagenes Specification

## Purpose
Ciclo de vida de una orden de captura: emisión, despacho por el canal de órdenes, recepción de la imagen correlacionada, acuse de fallo, vencimiento y reintento acotado.
