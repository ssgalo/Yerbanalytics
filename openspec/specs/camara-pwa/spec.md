# camara-pwa Specification

## Purpose
Cliente de referencia del contrato de captura: una PWA que corre en el navegador de un teléfono montado en el riel. Es reemplazable en bloque por un cliente nativo; sus requisitos describen cómo cumple el contrato bajo las restricciones de esa plataforma.
