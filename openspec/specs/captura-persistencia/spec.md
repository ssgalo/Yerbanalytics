# captura-persistencia Specification

## Purpose
Persistencia de órdenes, capturas, dispositivos de cámara y diagnósticos: la imagen va al filesystem y en la base queda su metadata.
