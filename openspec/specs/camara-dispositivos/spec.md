# camara-dispositivos Specification

## Purpose
Registro, credenciales y estado operativo de los dispositivos de captura: vinculación por código de un solo uso, tokens de acceso de vida corta, señal de vida y configuración remota de captura.
